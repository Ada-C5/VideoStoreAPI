...
var Rental = require('../../models/customer')
...
//       Rental.all(function (error, customers) {
...
//        Rental.find(customer1, function (error, customer) {
...
//       Rental.find("person", function(error, customer) {
//         expect(error.message).toEqual("Rental not found")
//       })
//     done()
//     })
//   })
